...
data_cfg.instruct_dataset.tokenized_train_data_path = os.path.join(data_cfg.path_to_data, 'instruct_part_1.pickle')
...
data_cfg.instruct_dataset.tokenizer_path = os.path.join(data_cfg.path_to_data, 'en_tokenizer.model')
