...
experiment_cfg.train.optimizer_params = {
    'Adam': {'betas': (0.9, 0.999), 'eps': 1e-8}, 'AdamW': {'betas': (0.9, 0.98), 'eps': 1e-9, 'weight_decay': 0.1}
}
...
experiment_cfg.inference.model_path = os.path.join(experiment_cfg.checkpoints_dir, 'sft_3_en')
